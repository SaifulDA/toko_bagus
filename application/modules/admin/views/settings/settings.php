  ...
  <div class="row">
        ...
        <div class="card">
          ...
          <div class="card-body bg-primary">
            ...
            <div class="form-group">
              <label class="form-control-label text-white" for="name">Nama toko:</label>
            ...
            <div class="row">
              <div class="col-6">
                <div class="form-group">
                  <label class="form-control-label text-white" for="phone_number">No. HP:</label>
            ...
            <div class="form-group">
              <label class="form-control-label text-white" for="address">Alamat:</label>
            ...
            <div class="form-group">
              <label class="form-control-label text-white" for="tagline">Tagline:</label>
            ...
            <div class="form-group">
              <label class="form-control-label text-white" for="description">Deskripsi:</label>
    ...
    <div class="col-md-4">
      <div class="card">
        ...
        <div class="card-body bg-primary">
          <div class="form-group">
            <label class="form-control-label text-white" for="pic">Foto:</label>
            <input type="file" name="picture" class="form-control" id="pic">
            <small class="text-white">Pilih foto PNG atau JPG dengan ukuran maksimal 2MB</small>
          </div>
        </div>
      </div>
      ...
      <div class="card">
        ...
        <div class="card-body bg-primary">
          <div class="form-group">
            <label class="form-control-label text-white" for="ongkir">Ongkos kirim:</label>
          ...
          <div class="form-group">
            <label class="form-control-label text-white" for="free_ongkir">Minimal belanja untuk gratis ongkir:</label>
            <div class="input-group mb-3">
              <div class="input-group-prepend">
                <span class="input-group-text" id="basic-addon1">Rp</span>
              </div>
